      ...
      <div className="max-w-[1400px] w-full mx-auto px-6 sm:px-12 flex-1 flex flex-col lg:flex-row items-center justify-center lg:justify-between gap-8 sm:gap-10 lg:gap-16 py-8 sm:py-10 lg:py-14">
        ...
        >
          <div className="relative group transition-transform duration-500 ease-out">
            ...
            <div className="absolute -inset-2 bg-gradient-to-b from-black/[0.03] to-black/[0.1] rounded-[2.6rem] sm:rounded-[2.8rem] blur-xl opacity-60 group-hover:opacity-90 transition-opacity duration-700 pointer-events-none" />
            ...
            <div className="relative p-2.5 sm:p-3 bg-white/75 backdrop-blur-md rounded-[2.4rem] sm:rounded-[2.5rem] border border-black/[0.07] shadow-[0_20px_50px_-15px_rgba(0,0,0,0.12)]">
              <div className="relative aspect-[3/4] rounded-[1.9rem] sm:rounded-[2rem] overflow-hidden bg-[#141517]">
                ...
                <div className="pointer-events-none absolute inset-0 rounded-[1.9rem] sm:rounded-[2rem] ring-1 ring-inset ring-white/10" />
              </div>
            </div>
          </div>
        </div>
